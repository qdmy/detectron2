...
https://raw.githubusercontent.com/quark0/darts/master/LICENSE
'''
...
from .genotypes import Genotype, CNAS
from .operation import OPERATIONS, FactorizedReduce, ReLUConvBN, Identity
