...
import numpy as np
from codebase.torchutils import logger, output_directory, summary_writer
...
class EvolutionFinder:
	...
	def __init__(self, efficiency_predictor, accuracy_predictor, superclass_id, **kwargs):
	...
	def random_valid_sample(self, constraint):
		while True:
			sample = self.arch_manager.random_sample_arch(self.superclass_id)
